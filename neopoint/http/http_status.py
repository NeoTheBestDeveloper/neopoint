...
class HttpStatus(IntEnum):
    ...
    HTTP_418_I_AM_A_TEAPOT = 418  # WARNING: Please, don't use it.
    ...
    def status_msg(self) -> str:
        match self.name:
            ...
            case "HTTP_207_MULTI_STATUS":
                return "Multi-Status"
            case "HTTP_418_I_AM_A_TEAPOT":
                return "I'm a teapot"
            case _:
                _, _, *words = self.name.split("_")

                words_in_camel_case = (self._word_to_camel_case(word) for word in words)
